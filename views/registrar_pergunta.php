...
<body>
<a href="index.php?action=iniciar_quiz">< Voltar</a>
...
$controller->listarUserId($_COOKIE['user_id']);


if(isset($_POST["opcao_4"])){
    $esporteController = new QuizController($pdo);
    $esporteController->criarPergunta($_POST['texto_pergunta'],$_POST['resposta_correta'],$_POST['opcao_1'],$_POST['opcao_2'],$_POST['opcao_3'],$_POST['opcao_4'],$_COOKIE['user_id']);
}